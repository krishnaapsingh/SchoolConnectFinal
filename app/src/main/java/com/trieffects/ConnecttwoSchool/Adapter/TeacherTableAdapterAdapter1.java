...
public class TeacherTableAdapterAdapter1 extends RecyclerView.Adapter<TeacherTableAdapterAdapter1.ViewHolder>{
    List<Timemodel> listData=new ArrayList<>();
    Context context;
    float txt;
    public TeacherTableAdapterAdapter1(List<Timemodel> list, Context mcontext, int item, float txtsize){
       listData=list;
       context=mcontext;
        txt=txtsize;
    }
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View v = inflater.inflate(R.layout.teacher_timeview, parent, false);
